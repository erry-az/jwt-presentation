...
>
  Technical Lead yang hobi ngebangun sistem backend yang tangguh, skalabel, dan kencang. Sudah ada pengalaman <span v-mark.underline.blue>13+ tahun</span> di bidang ini.
</div>
...
<div class="flex gap-2 items-center text-gray-400">
  <span class="text-yellow-400">▸</span> <span class="text-gray-200">paper.id</span> — Technical Lead <span class="text-blue-400 text-xs ml-1">(Sekarang)</span>
</div>
</div>
...
>
  🎓 **Universitas Budi Luhur** — Sarjana Ilmu Komputer <br>
  🏫 **SMK Telkom** — Jakarta
</div>
